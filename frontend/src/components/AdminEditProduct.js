     ...
     w-full h-full bottom-0 top-0 left-0 right-0'>
        ...
        overflow-hidden'>
            ...
            <div className='flex justify-between items-center pb-3'>
                ...
                text-2xl hover:text-[#FF6700]' onClick={onClose}>
            ...
            <form className='grid p-4 gap-2 overflow-y-scroll h-full pb-5' onSubmit={handleSubmit}>
              ...
              <div>
                {
                  data?.productImage[0] ? (
                        ...
                        data.productImage.map((el, index) => {
                          return (
                            <div className='relative group'>
                              ...
                              <div className='absolute bg-[#FF6700] rounded-full
                    ...
                    <p className='text-[#FF6700]text-xs'>*Please Upload Product Image</p>
                  )
                }
              </div>
              ...
              {/* Submit button */}
              <button className='px-3 hover:bg-orange-500 
              text-white py-2 mb-10 bg-[#FF6700]'>Update Product</button>
            </form>
