...
const createDocument = require('../controller/propertyDocument/createDocument');
const getAllDocuments = require('../controller/propertyDocument/getAllDocuments');
const getDocumentsByEmail = require('../controller/propertyDocument/getDocumentsByEmail');
...
router.post("/create-document",authToken, createDocument)
